  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="text-sm font-medium text-white/80">Contas bancárias</div>
          <div className="text-xs text-white/30">Saldo cadastrado: {currency(total)}</div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        {accounts.map((account) => (
          <div key={account.id} className="border border-border p-3 text-sm">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center justify-between gap-3 sm:justify-end">
                  ...
                  <div className="flex gap-2">
                    <Button className="size-8 bg-transparent px-0 text-white/80 hover:bg-white/10" title="Editar conta" onClick={() => setEditingId(account.id)}>
                      <Pencil size={15} />
                    </Button>
                    <Button
        ...
        {accounts.length === 0 ? <div className="border border-border p-3 text-sm text-white/30">Nenhuma conta cadastrada.</div> : null}
      </div>
    </div>
  );
}
